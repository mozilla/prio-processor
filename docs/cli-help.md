...
Options:
  ...
  --batch-id TEXT              A shared batch identifier used as a validity
                               check.  [required]
  --shared-secret BYTES        The shared server secret encoded in base64.
                               [required]
  --private-key BYTES          The private key of the processing server.
                               [required]
  --server-id [A|B]            The identifier for match.  [required]
  --public-key-external BYTES  The public key of the co-processing server.
                               [required]
  --public-key-internal BYTES  The public key of the processing server.
                               [required]
  --input-external DIRECTORY   Directory containing data generated by the co-
                               processing server.  [required]
  --input-internal DIRECTORY   Directory containing data generated by the
                               processing server.  [required]
...
Options:
  ...
  --public-key-internal BYTES  The public key of the processing server.
                               [required]
  --input DIRECTORY            Directory containing shares from clients.
                               [required]
